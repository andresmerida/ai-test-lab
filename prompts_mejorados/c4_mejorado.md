...
- **Métricas**:
  - `mermaid_render_success`: Ratio de compilación e inspección gráfica exitosa del código Mermaid ($\ge 100\%$).
  - `container_count_metric`: Total de contenedores distribuidos en el Nivel 2 (debe estar en el rango de 6 a 12).
